...
class SMBTestCreditsViewController: UITableViewController {
                ...
                PFCloud.callFunctionInBackground("purchaseCredits", withParameters: params, block: { (response, error) -> Void in
                    ...
                    if response != nil {
                        ...
                        SMBUser.currentUser()!.fetchInBackgroundWithBlock({ (object, error) -> Void in
                            SMBUser.currentUser().credits.fetchInBackgroundWithBlock({ (object, error) -> Void in
    ...
    func spendCreditsAction(amount: Int) {
        ...
        PFCloud.callFunctionInBackground("spendCredits", withParameters: params) { (response, error) -> Void in
